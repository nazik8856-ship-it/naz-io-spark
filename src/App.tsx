...
const ControlActionReversals = lazyWithReload(() => import("./pages/ControlActionReversals"));
          ...
          <EntranceSplash>
            ...
            <Suspense fallback={<PageSkeleton />}>
              <Routes>
                ...
                <Route path="/control-system/action-reversals" element={<ControlActionReversals />} />
