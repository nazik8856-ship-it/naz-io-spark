              ...
              >
                <div
                  ...
                  style={{
                    ...
                    border: msg.role === "user" ? `1px solid rgba(${glowRgba},0.2)` : "1px solid rgba(255,255,255,0.06)",
          ...
          <div className="w-full max-w-2xl mb-6 relative">
            <div
              ...
              style={{
                ...
                boxShadow: activeTool ? `0 0 0 1px rgba(${glowRgba},0.15), 0 0 24px rgba(${glowRgba},0.15)` : "none",
            ...
            >
              ...
              <textarea
                ...
                placeholder={activeTool ? `Ask ${activeTool.tool.name} anything... (↵ to send)` : "Describe your system mission... (↵ to send)"}
                rows={1}
