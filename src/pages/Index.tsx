    ...
    <div className="min-h-screen bg-black text-white selection:bg-emerald-500/30 font-sans">
      ...
      <nav className="relative z-50 flex justify-between items-center px-8 py-6 max-w-7xl mx-auto border-b border-white/5 bg-black/50 backdrop-blur-md sticky top-0">
        ...
        <div className="flex items-center gap-6">
          {/* Updated Sign In to use Workspace for now */}
          <button
        ...
        <section id="pricing" className="py-24 px-6 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <PriceCard
              ...
              price="$99"
              tier="Scale"
              features={["Team Orchestration", "API Access"]}
              btnText="Contact Ops"
            />
          </div>
        </section>
...
// Helper Components with click events
