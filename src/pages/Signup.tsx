...
const getAuthErrorMessage = (message: string) => {
  ...
  if (normalized.includes("invalid login credentials")) {
    return { title: "Invalid credentials", description: "That email or password didn't match. Try again or use a social login." };
  }
        ...
        >
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-3 text-white/25" style={{ background: "#020617" }}>or</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              <Label htmlFor="name" className="text-xs text-white/50 font-medium">Full Name</Label>
              <Input
                id="name"
                type="text"
            ...
            <div className="space-y-1.5">
              <Label htmlFor="email" className="text-xs text-white/50 font-medium">Email</Label>
              <Input
                id="email"
                type="email"
            ...
            <div className="space-y-1.5">
              <Label htmlFor="password" className="text-xs text-white/50 font-medium">Password</Label>
              <Input
                id="password"
                type="password"
                placeholder="••••••••"
