        ...
        {generatedCode && (
          <div className="fixed bottom-32 right-12 z-[100]">
            <button
              ...
              className="flex items-center gap-3 px-6 py-3.5 rounded-full border-2 shadow-[0_0_30px_rgba(0,0,0,0.5)] transition-all active:scale-95 duration-300"
              style={{
                borderColor: saveState === "success" ? "#22c55e" : saveState === "error" ? "#ef4444" : saveState === "saving" ? "#eab308" : "rgba(16,185,129,0.5)",
                background: saveState === "success" ? "rgba(34,197,94,0.15)" : saveState === "error" ? "rgba(239,68,68,0.15)" : "rgba(16,185,129,0.12)",
