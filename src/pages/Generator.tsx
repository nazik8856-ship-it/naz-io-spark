      ...
      <main className="flex-1 flex flex-col min-w-0 bg-[#020617] relative">
        ...
        <div className="flex-1 overflow-y-auto p-12 font-mono scrollbar-hide">
          <div className="max-w-4xl mx-auto space-y-4">
            ...
            {error && (
              <div className="mt-4 p-4 bg-red-500/10 border border-red-500/20 rounded-lg flex items-center gap-3 text-red-400 text-xs uppercase tracking-tighter">
              ...
              <div className="mt-8 rounded-xl border border-white/10 overflow-hidden shadow-2xl animate-in fade-in zoom-in-95 duration-500">
                ...
                <div className="bg-[#010d1f] border-t border-white/5 px-6 py-4 flex items-center justify-between gap-4">
                  <div className="flex items-center gap-2 text-[10px] font-mono text-slate-500">
                    ...
                    <span>MISSION_SUCCESS // DATA_STREAM_STABLE</span>
                  </div>
                  <div className="flex gap-3">
                    ...
                    >
                      ...
                      {saveSuccess ? "Mission Archived" : "Archive to Database"}
                    </button>
                  </div>
                </div>
              </div>
        ...
        <div className="p-8 bg-gradient-to-t from-[#020617] via-[#020617] to-transparent">
          ...
          <p className="text-center text-[9px] text-slate-700 mt-4 tracking-[0.2em] uppercase font-mono">
            Powered by OpenRouter // Database: Supabase
          </p>
        </div>
      </main>
    </div>
