...
const PasswordChangedEmail = ({ email, timestamp }: PasswordChangedProps) => {
  ...
  return (
    <Html lang="en" dir="ltr">
      <Head />
      <Preview>Your NazAI password was changed.</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={card}>
            ...
            <Text style={lead}>
              The password for {email ? <strong>{email}</strong> : 'your NazAI account'} was successfully changed.
            </Text>
            ...
            <Text style={footnote}>
              Wasn't you? <Link href={`${APP_URL}/`} style={footerLink}>Reset your password</Link> immediately —
              whoever changed it may have access to your account.
            </Text>
          </Section>

          <Section style={footerWrap}>
            <Text style={footerSmall}>
              © {new Date().getFullYear()} {SITE_NAME}. This is a security notice sent on every password change.
            </Text>
          </Section>
        </Container>
      </Body>
...
export const template = {
  ...
  subject: 'Your NazAI password was changed',
  displayName: 'Password changed',
  previewData: { email: 'founder@example.com', timestamp: new Date().toISOString() },
